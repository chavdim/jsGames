...
function getMainMenuBG () {
	...
	new BackgroundVisualObject(imgSource="./images/mainMenu.png",animatedImages=[],0)
	];
	return bgObj;
};
...
function getStageBG (which) {
	...
	new BackgroundVisualObject(imgSource="./images/bgMain.jpg",animatedImages=[],60)
	];
	return bgObj;
};
...
function getStageMenuObjects (which) {
	...
	var menuObj=[
	 ...
	 new Button("","p4",310,495,80,40,function func () {game.kakikouriGame.usePower("4");}),
	...
	new BackgroundVisualObject(imgSource="./images/green.png",animatedImages=[],90)
	];
	return menuObj;
};
//STAGE non basic
